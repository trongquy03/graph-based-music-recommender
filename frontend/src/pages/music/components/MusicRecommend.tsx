...
const MusicRecommendSection = ({ songs, isLoading = false, error = null }: Props) => {
  ...
  if (!songs || songs.length === 0) return <p className="text-zinc-400">Không có bài hát để hiển thị.</p>;
